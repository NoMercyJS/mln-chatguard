...
.addField('<a:mln_yildiz:815182914950135839> Komutlar Ve Kullanımları',`
<a:mln_yildiz:815182914950135839> **Whitelist** = __${config.prefix}whitelist ekle/kaldır__
<a:mln_yildiz:815182914950135839> **Reklam koruma** = __${config.prefix}reklamakoruma aç/kapat__
<a:mln_yildiz:815182914950135839> **Küfür koruma** = __${config.prefix}küfürkoruma aç/kapat__
<a:mln_yildiz:815182914950135839> **Spam koruma** = __${config.prefix}spamkoruma aç/kapat__
<a:mln_yildiz:815182914950135839> **Caps koruma** = __${config.prefix}capskoruma aç/kapat__
<a:mln_yildiz:815182914950135839> **Etiket koruma** = __${config.prefix}etiketkoruma aç/kapat__
<a:mln_yildiz:815182914950135839> **Mesaj limit** = __${config.prefix}mesajlimit aç/kapat__
...
.setColor('RANDOM')
.setAuthor(message.member.user.username, message.member.user.displayAvatarURL({dynamic: true, format: "png", size: 1024}))
.addField('<a:mln_yildiz:815182914950135839> Korumalar',`

<a:mln_yildiz:815182914950135839> **Reklam koruma**: ${reklamaktif}
<a:mln_yildiz:815182914950135839> **Küfür koruma**: ${kufuraktif}
<a:mln_yildiz:815182914950135839> **Spam koruma**: ${spamaktif}
<a:mln_yildiz:815182914950135839> **Caps koruma**: ${capsaktif}
<a:mln_yildiz:815182914950135839> **Etiket koruma**: ${etiketaktif}
<a:mln_yildiz:815182914950135839> **Mesaj limit**: ${karakteraktif}
 `)
.setTimestamp()
.setFooter(message.guild.name, message.guild.iconURL({dynamic: true, format: "png", size: 1024}))
...
if(whitelist === 1 ) return message.channel.send(`${member}  üye zaten whitelist de.`)

if(whitelist !== 1 ) message.channel.send(`${member}  üye başarılı bir şeklide whiteliste eklendi.`)})
